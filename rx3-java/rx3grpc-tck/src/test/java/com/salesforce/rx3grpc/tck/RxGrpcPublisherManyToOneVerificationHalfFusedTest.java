...
@Test(timeOut = 3000)
public class RxGrpcPublisherManyToOneVerificationHalfFusedTest
        extends PublisherVerification<Message> {
    public static final long DEFAULT_TIMEOUT_MILLIS = 500L;
    public static final long PUBLISHER_REFERENCE_CLEANUP_TIMEOUT_MILLIS = 1000L;

    public RxGrpcPublisherManyToOneVerificationHalfFusedTest() {
    ...
    public Publisher<Message> createPublisher(long elements) {
        ...
        Single<Message> publisher = request.hide().to(stub::manyToOne);
